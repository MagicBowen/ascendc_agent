...
file_name_without_extension = os.path.splitext(os.path.basename(transcript_file))[0]
new_directory = os.path.dirname(os.path.abspath(__file__)) + "/../../logs/"
new_extension = '.md'

output_file_path = os.path.join(new_directory, file_name_without_extension + new_extension)
